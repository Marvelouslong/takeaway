...
public class storeDaoImpl implements storeDao {
    ...
    public List<store> getstoreList(Connection connection) throws  Exception{
        ...
        while(rs.next()){
            ...
            Blob brand_authorization= (Blob) rs.getBlob(7);
            long bank_card=rs.getLong(8);
            Blob license= (Blob) rs.getBlob(9);
            Blob certificate_of_business= (Blob) rs.getBlob(10);
            String legal_id_card=rs.getString(11);
            String status=rs.getString(12);
            Blob shop_picture= (Blob) rs.getBlob(13);
